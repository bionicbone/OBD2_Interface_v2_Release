...
void TFT_eSPI::convertRawXY(uint16_t *x, uint16_t *y)
{
  ...
  //Serial.println("convertRawXY()");
  //Serial.println("Initial Incoming Values:");
  //Serial.print("x"); Serial.println(*x);
  //Serial.print("y"); Serial.println(*y);
  //Serial.print("xx"); Serial.println(xx);
  //Serial.print("yy"); Serial.println(yy);

  //Serial.print("touchCalibration_rotate = "); Serial.println(touchCalibration_rotate);
  //Serial.print("touchCalibration_invert_x = "); Serial.println(touchCalibration_invert_x);
  //Serial.print("touchCalibration_invert_y = "); Serial.println(touchCalibration_invert_y);
...
void TFT_eSPI::calibrateTouch(uint16_t *parameters, uint32_t color_fg, uint32_t color_bg, uint8_t size){
  ...
  if(parameters != NULL){
    ...
    //Serial.print("touchCalibration_x0 = "); Serial.println(touchCalibration_x0);
    //Serial.print("touchCalibration_x1 = "); Serial.println(touchCalibration_x1);
    //Serial.print("touchCalibration_y0 = "); Serial.println(touchCalibration_y0);
    //Serial.print("touchCalibration_y1 = "); Serial.println(touchCalibration_y1);
    //
    //Serial.print("touchCalibration_rotate = "); Serial.println(touchCalibration_rotate);
    //Serial.print("touchCalibration_invert_x = "); Serial.println(touchCalibration_invert_x);
    //Serial.print("touchCalibration_invert_y = "); Serial.println(touchCalibration_invert_y);
    //Serial.print("parameters[4] (rotate | invert_x <<1 | invert_y <<2) = "); Serial.println(parameters[4]);
  }
}
...
void TFT_eSPI::setTouch(uint16_t *parameters){
  ...
  //Serial.println("setTouch Parameters:");
  //Serial.print("touchCalibration_x0 = "); Serial.println(touchCalibration_x0);
  //Serial.print("touchCalibration_x1 = "); Serial.println(touchCalibration_x1);
  //Serial.print("touchCalibration_y0 = "); Serial.println(touchCalibration_y0);
  //Serial.print("touchCalibration_y1 = "); Serial.println(touchCalibration_y1);
  ...
  //Serial.print("touchCalibration_invert_x = "); Serial.println(touchCalibration_invert_x);
  //Serial.print("touchCalibration_invert_y = "); Serial.println(touchCalibration_invert_y);
  //Serial.print("parameters[4] = "); Serial.println(parameters[4]);
